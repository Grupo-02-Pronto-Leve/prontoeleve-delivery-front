...
function Sobre() {
    ...
    const team = [
        { name: "Adrielli Bertoldo", img: "https://github.com/Adrielli-Bertoldo.png", linkedin: "#", github: "#" },
        { name: "Diego Cavalcanti", img: "https://ik.imagekit.io/iyc9bztrf8/diego.jpg?updatedAt=1755102273597", linkedin: "#", github: "#" },
        { name: "Miguel Ferreira", img: "https://github.com/devvMiguel.png", linkedin: "#", github: "#" },
        { name: "Natália Gadelha", img: "https://ik.imagekit.io/iyc9bztrf8/nataliag.jpeg?updatedAt=1755102273677", linkedin: "#", github: "#" },
        { name: "Natalia Taira", img: "https://ik.imagekit.io/iyc9bztrf8/nataliat.jpeg?updatedAt=1755102273747", linkedin: "#", github: "#" },
        { name: "Nathalia Carvalho", img: "https://ik.imagekit.io/iyc9bztrf8/nathaliac.png?updatedAt=1755102274054", linkedin: "#", github: "#" },
        { name: "Taís Escobar", img: "https://ik.imagekit.io/iyc9bztrf8/tais.jpg?updatedAt=1755102274340", linkedin: "#", github: "#" },
    ];
    ...
    return (
        ...
        {/* HERO SECTION */}
            <section
    className="w-full bg-black text-white py-28 text-center bg-cover bg-center relative"
    style={{
        backgroundImage: "url('https://ik.imagekit.io/iyc9bztrf8/photo-1572424117831-005b5e9b3ae4.avif?updatedAt=1755107188212')", // coloque aqui o link da foto de comida
    }}
    >
    ...
    <div className="relative z-10 max-w-3xl mx-auto px-4">
        ...
        {/* SEÇÃO TÉCNICA */}
        <section className="w-full flex justify-center bg-gray-800 text-white py-16">
        <div className="flex flex-col items-center w-full max-w-7xl px-4">
            ...
            {crudFeatures.map((feature, index) => (
                <div
                key={index}
                className="bg-gray-600 rounded-lg p-6 text-center hover:scale-105 transition-transform"
                >
        ...
        <section className="w-full py-10 bg-green-50">
            ...
            {team.map((member, index) => (
                ...
                />
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a
